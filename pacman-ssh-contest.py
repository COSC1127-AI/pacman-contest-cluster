...
class ContestRunner:
    ...
    def __init__(self, teams_root, include_staff_team, staff_teams_dir, compress_logs,
        ...
        self.stats_archive_dir = stats_archive_dir or self.DEFAULT_STATS_ARCHIVE_DIR
        self.logs_archive_dir = logs_archive_dir or self.DEFAULT_LOGS_ARCHIVE_DIR
        self.replays_archive_dir = replays_archive_dir or self.DEFAULT_REPLAYS_ARCHIVE_DIR
